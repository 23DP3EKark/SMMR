      ...
      <form @submit.prevent="register" class="w-full max-w-sm border-2 border-t-white border-r-black border-b-black border-l-white bg-[#c0c0c0] p-2">
        ...
        <div class="flex flex-col gap-3 p-3 text-sm">
          <div>
            ...
            <input v-model="user.first_name" type="text" class="w-full border-2 border-t-black border-r-white border-b-white border-l-black bg-white px-1 py-[2px] outline-none" required />
          </div>

          <div>
            <label for="last_name" class="mb-1 block">uzvārds:</label>
            <input v-model="user.last_name" type="text" class="w-full border-2 border-t-black border-r-white border-b-white border-l-black bg-white px-1 py-[2px] outline-none" required />
          </div>

          <div>
            <label for="email" class="mb-1 block">epasts:</label>
            <input v-model="user.email" type="text" class="w-full border-2 border-t-black border-r-white border-b-white border-l-black bg-white px-1 py-[2px] outline-none" required />
          </div>

          <div>
            <label for="password" class="mb-1 block">parole:</label>
            <input v-model="user.password" type="password" class="w-full border-2 border-t-black border-r-white border-b-white border-l-black bg-white px-1 py-[2px] outline-none" required />
          </div>


          <div>
            <label for="password" class="mb-1 block">atkārtota parole:</label>
            <input v-model="user.password_confirmation" type="password" class="w-full border-2 border-t-black border-r-white border-b-white border-l-black bg-white px-1 py-[2px] outline-none" required />
          </div>
          ...
          <button class="border-2 border-t-white border-r-black border-b-black border-l-white bg-[#c0c0c0] px-3 py-1 active:border-t-black active:border-r-white active:border-b-white active:border-l-black">PieregistrÄ“ties</button>
